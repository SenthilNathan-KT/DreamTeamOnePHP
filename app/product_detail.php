            ...
            <a href="./products.php"
               ...
               aria-label="Back">
                <svg class="svg-icon" viewBox="0 0 20 20">
                    <path fill="none"
                          d="M13.5,10c0,0.276-0.224,0.5-0.5,0.5H3.707l3.646,3.646c0.195,0.195,0.195,0.512,0,0.707c-0.098,0.098-0.226,0.146-0.354,0.146s-0.256-0.049-0.354-0.146L2.146,11.354c-0.195-0.195-0.195-0.512,0-0.707L6.354,6.854c0.195-0.195,0.512-0.195,0.707,0c0.195,0.195,0.195,0.512,0,0.707L3.707,10H13C13.276,10,13.5,10.224,13.5,10z"/>
                </svg>
            </a>
        </li>
        <li>
...
<div class="container">
    ...
    >
        <img
                src="./../images/<?php echo $product->getBpImage(); ?>.png" alt="<?php echo $product->getBpName(); ?>">
    </div>

    <p>
        <?php echo $product->getBpDescription(); ?>
    </p>
